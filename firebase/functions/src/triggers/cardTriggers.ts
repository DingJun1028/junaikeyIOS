 ...
 * 卡牌觸發器 - 監聽卡牌集合的變化
 */
export const cardTriggers = functions.firestore
 ...
 * 代理狀態觸發器 - 監聽代理狀態變化
 */
export const agentStatusTrigger = functions.firestore
 ...
 * 數據品質監控觸發器
 */
export const dataQualityMonitor = functions.firestore
 ...
 * 系統健康監控觸發器
 */
export const systemHealthMonitor = functions.pubsub
 ...
 * 觸發代理恢復
 */
async function triggerAgentRecovery(agentId: string, agentData: any) {
  const db = admin.firestore();
